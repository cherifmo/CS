rm ../../icasa.teaching.distribution/applications/*.jar
mv icasa.light.api/target/*.jar ../../icasa.teaching.distribution/applications/
mv icasa.light.manager/target/*.jar ../../icasa.teaching.distribution/applications/
